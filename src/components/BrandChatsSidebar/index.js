        ...
        return (
          ...
          >
            <Link href={`/chats/${chat.id}`}>
              <a className={`md:px-6 py-4 flex items-center  ${!chat.brandRead ? 'font-semibold' : ''}`}>
                {!chat.avatar ? (
                ...
                <div className='ml-4 truncate'>
                  <div className='text-gray-900 truncate'>{chat.name}</div>
...
export default BrandChatsSidebar;
